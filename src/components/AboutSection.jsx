        ...
        <div className="about-content">
          <div className="about-text glass-card animate-fade-in">
            <p className="lead-text">
              I am a Software Engineer with <span className="highlight-text">around 2 years of experience</span> crafting robust backend systems and elegant software solutions.
            </p>
            ...
            <div className="quick-facts">
              <div className="fact-item">
                ...
                <div className="fact-text">Backend Specialist</div>
              </div>
              <div className="fact-item">
                <div className="fact-icon">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="2" width="20" height="8" rx="2" ry="2"/><rect x="2" y="14" width="20" height="8" rx="2" ry="2"/><line x1="6" y1="6" x2="6.01" y2="6"/><line x1="6" y1="18" x2="6.01" y2="18"/></svg>
                </div>
                <div className="fact-text">Microservices</div>
              </div>
              <div className="fact-item">
                <div className="fact-icon">
                ...
                <div className="fact-text">Fintech Enthusiast</div>
              </div>
            </div>
          </div>
          ...
          <div className="about-stats animate-fade-in" style={{ animationDelay: '0.2s' }}>
            <div className="stat-card glass-card">
              <div className="stat-number highlight">2+</div>
              <div className="stat-label">Years of<br/>Experience</div>
            </div>
            <div className="stat-card glass-card">
              <div className="stat-number highlight">10+</div>
              <div className="stat-label">Projects<br/>Completed</div>
            </div>
            <div className="stat-card glass-card">
              <div className="stat-number highlight">5+</div>
              <div className="stat-label">Microservices<br/>Deployed</div>
            </div>
          </div>
        </div>
      </div>
